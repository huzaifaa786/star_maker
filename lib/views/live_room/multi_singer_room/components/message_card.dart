...
//   WidgetSpan get space => WidgetSpan(child: SizedBox(width: 10));
...
//             borderRadius:
//                 widget.borderRadius ?? BorderRadius.all(Radius.circular(26)),
//           ),
//           child: Padding(
...
//   Widget message() {
//     final padding =
//         widget.paddings ?? EdgeInsets.fromLTRB(20, 10, 20, 10);
//     return RichText(
...
//             WidgetSpan(
//               child: SizedBox(
//                 width: 26 + padding.vertical / 2 - 1,
//                 height: 26 + padding.vertical / 2 - 1,
//                 child: ZegoAvatar(
//                   user: widget.message.user,
//                   avatarSize: Size(30, 30),
...
//                 maxWidth: 34 + widget.namePrefix!.length * 12,
//                 minWidth: 34,
//                 minHeight: 36,
//                 maxHeight: 36,
//               ),
